                ...
                <div class="portfolio-site__page portfolio-site__page--active" id="page-home">
                    <div class="portfolio-site__hero">
                        ...
                        <div class="portfolio-site__social">
                            <a href="<?php echo htmlspecialchars($linkedinUrl, ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener noreferrer" class="portfolio-site__social-link" title="LinkedIn">in</a>
                            <a href="#" class="portfolio-site__social-link" title="Behance">Bē</a>
                            <a href="<?php echo htmlspecialchars($githubUrl, ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener noreferrer" class="portfolio-site__social-link" title="GitHub">🐙</a>
                        </div>
                    </div>
                </div>
                    ...
                    <main class="portfolio-site__main">
                        <article class="portfolio-site__case-study">
                            ...
                            <section class="portfolio-site__case-section">
                                <h3>Visual Showcase</h3>
                                <div class="portfolio-site__media-grid">
                                    <div class="portfolio-site__media-placeholder">System architecture</div>
                                    <div class="portfolio-site__media-placeholder">Trade lifecycle states</div>
                                    <div class="portfolio-site__media-placeholder">Mobile trade flow</div>
                                </div>
                            </section>
                            <footer class="portfolio-site__case-footer">
                                <button class="portfolio-site__case-nav-btn" data-page="projects">Back to all case studies</button>
