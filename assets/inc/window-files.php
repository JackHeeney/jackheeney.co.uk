...
$documentsByFolder = portfolio_get_documents_by_folder();
...
<div class="window window--hidden" id="window-files" style="left:280px;top:150px;width:700px;height:460px;">
    ...
    <div class="window__body files">
        ...
        <div class="files__view files__view--docs">
            <div class="files__header">
                <button class="files__back" data-files-back>Main</button>
                <h3>My Documents <span class="files__count">(<?php echo count($documents); ?>)</span></h3>
            </div>
            <div class="docs-list">
                ...
                <?php else : ?>
                    <?php $isFirstFolder = true; ?>
                    <?php foreach ($documentsByFolder as $folder => $folderDocuments) : ?>
                        <div class="files__table-folder<?php echo $isFirstFolder ? ' files__table-folder--first' : ''; ?>">
                            <?php echo htmlspecialchars($folder, ENT_QUOTES, 'UTF-8'); ?>
                            <span class="files__table-folder-count"><?php echo count($folderDocuments); ?></span>
                        </div>
                        <?php foreach ($folderDocuments as $doc) : ?>
                            <div
                                class="doc"
                            ...
                            >
                                ...
                                <p><?php echo htmlspecialchars(basename($doc['filename']), ENT_QUOTES, 'UTF-8'); ?></p>
                            </div>
                        <?php endforeach; ?>
                        <?php $isFirstFolder = false; ?>
                    <?php endforeach; ?>
